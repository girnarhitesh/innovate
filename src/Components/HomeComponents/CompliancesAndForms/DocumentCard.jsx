...
const DocumentCard = ({ document, index }) => (
    <div className="DocumentCard" style={{ animationDelay: `${index * 0.1}s` }}>
        <div className="DocumentIcon">
            <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="DocumentIconSvg" aria-hidden="true">
        ...
        <a
            ...
            target="_blank"
            rel="noreferrer"
            aria-label={`View ${document.title} PDF`}
        >
