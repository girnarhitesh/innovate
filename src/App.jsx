          ...
          <main id="main-content" tabIndex={-1}>
            <Routes>
              ...
              <Route
                ...
                element={<InvestorChartersPage />}
              />
              <Route
                path="/compliances/compliance-data"
                element={<ComplianceDataPage />}
              />
              <Route
                path="/compliances/mf-compliance"
                element={<MfCompliancePage />}
              />
              <Route
                path="/compliances/mf-compliance/:slug"
                element={<MfComplianceDetailPage />}
              />
              <Route path="/disclaimer" element={<Disclaimer />} />
              <Route path="/privacy-policy" element={<PrivacyPolicy />} />
              <Route
                path="/advisiory-for-investors"
                element={<AdvisioryForInvestors />}
              />
              <Route
                path="/investor-complaints-disclosure"
                element={<InvestorComplaints />}
              />
